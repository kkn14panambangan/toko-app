...
<div class="container py-5 d-flex justify-content-center">
    <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; max-width: 500px; width: 100%; background-color: #2F1E14;">
        ...
        <div class="card-body p-0 text-center" style="background-color: #1A1614;">
            <!-- The actual QR Image -->
            <img src="{{ Storage::url('products/qr-menu.png') }}" alt="QR Menu Kembang Tahu" class="img-fluid" style="width: 100%;">
            
            <div class="p-4" style="background-color: #2F1E14;">
                <a href="{{ Storage::url('products/qr-menu.png') }}" download="QR_Menu_Kembang_Tahu.png" class="btn w-100 rounded-pill fw-bold py-3 mb-2" style="background-color: #D4AF37; color: #1A1614; font-size: 1.1rem; box-shadow: 0 4px 12px rgba(212, 175, 55, 0.3);">
